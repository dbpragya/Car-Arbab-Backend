                    ...
                    <div class="card-body">
                        <div class="widget-stats-container d-flex">
                            <div class="widget-stats-content flex-fill">
                                <form class="row g-3" action="{{ route('admin.store_auction')}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control" id="bid_start_price" name="bid_start_price" value="{{ $carauction ?  $carauction->bid_start_price : old('bid_start_price') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="estimated_repair_cost" name="estimated_repair_cost" value="{{ $carauction ?  $carauction->estimated_repair_cost : old('estimated_repair_cost') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="estimated_market_value" name="estimated_market_value" value="{{ $carauction ?  $carauction->estimated_market_value : old('estimated_market_value') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="buy_now_price" name="buy_now_price" value="{{ $carauction ?  $carauction->buy_now_price : old('buy_now_price') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="reserve_price" name="reserve_price" value="{{ $carauction ?  $carauction->reserve_price : old('reserve_price') }}"> 
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <label for="auction_lane" class="form-label">Auction Lane</label>
                                        <input type="text" class="form-control" id="auction_lane_value" name="auction_lane_value" value="{{ $carauction ?  $carauction->auction_lane_value : old('auction_lane_value') }}" disabled>
                                        <input type="text" class="form-control" id="auction_lane" name="auction_lane" value="{{ $carauction ?  $carauction->auction_lane : old('auction_lane') }}" disabled>
                                        <div class="error-message">{{$errors->first('auction_lane')}}</div>
                                    </div>
                                    ...
                                    <div class="row cstm-date mt-5">
                                        <div class="col-md-6 cstm-date ">
                                            ...
                                            <input class="cstm-form_input" type="date" id="auction_date" name="auction_date"  value="{{ $carauction ?  $carauction->auction_date : old('auction_date') }}" >
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="service_cost" name="service_cost" value="{{ $carauction ?  $carauction->service_cost : old('service_cost') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="vehicle_insurance_price" name="vehicle_insurance_price" value="{{ $carauction ?  $carauction->vehicle_insurance_price : old('vehicle_insurance_price') }}">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="delivery_price" name="delivery_price" value="{{ $carauction ?  $carauction->delivery_price : old('delivery_price') }}">
                                        </div>
                                        <div class="error-message">{{$errors->first('vehicle_insurance_price')}}</div>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="buy_back_guarantee_cost" class="form-label">Buy Back Guarantee Cost</label>
                                        <div class="input-group">
                                            <span class="input-group-text">$</span>
                                            <input type="number" class="form-control" id="buy_back_guarantee_cost" name="buy_back_guarantee_cost" value="{{ $carauction ?  $carauction->buy_back_guarantee_cost : old('buy_back_guarantee_cost') }}">
                                        </div>
    ...
    <!-- <script>
        $(document).ready(function() {
            $('#auction_type_id').change(function() {
                ...
                var selectedAuctionType = $(this).val();
                // alert(selectedAuctionType);

                if (selectedAuctionType == '2') {
                    $('.cstm-date').show();
                } else {
                    $('.cstm-date').hide();
                }
